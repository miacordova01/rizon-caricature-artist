...
Requires models/face_landmarker.task — download with:
...
LEFT_PUPIL  = 468   # iris centre — included in face_landmarker.task
RIGHT_PUPIL = 473
...
class FaceDetector:
    """Detects face landmarks using MediaPipe FaceLandmarker (Tasks API)."""
